...
Feature: Create spinner item
  ...
  Scenario: Successful create item
    ...
    And I expect add form to be cleared
  ...
  Scenario: Cancel delete item
    ...
    And I click "Cancel" button on the shown pop-up
    Then I expect that confirmation pop-up closed
    And I expect that items list don't change

  Scenario: Delete item
    When I click on more settings button
    And I click "delete" button
    And I click "Delete" button on the shown pop-up
    Then I expect that confirmation pop-up closed
